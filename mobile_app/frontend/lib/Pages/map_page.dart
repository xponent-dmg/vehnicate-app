...
class _MapPageState extends State<MapPage> with TickerProviderStateMixin {
    ...
    try {
      ...
      final transformedData = data.map((item) {
        return {
          ...
          // 'dataid' is GENERATED ALWAYS AS IDENTITY
          'vehicleid': item['vehicleid'], // Make sure this exists in vehicledetails table
    ...
    _autocompleteTimer = Timer(const Duration(milliseconds: 300), () async {
      try {
        ...
        final response = await http.get(
          Uri.parse('https://api.openrouteservice.org/geocode/autocomplete?'
              'api_key=$apiKey&'
              ...
              'boundary.circle.radius=50'),  // 50km radius for autocomplete
        );
  ...
  Future<void> _calculateRoute() async {
    ...
    try {
      ...
      final url = '${Config.openRouteServiceBaseUrl}/v2/directions/driving-car?'
          'api_key=$apiKey&'
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      IconButton(
                        onPressed: _isTrackingLocation ? _stopLiveTracking : _startLiveTracking,
                        icon: Icon(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return ListTile(
                            ...
                            subtitle: label.isNotEmpty && label != name
                                ? Text(
                                    label,
                                    style: const TextStyle(
