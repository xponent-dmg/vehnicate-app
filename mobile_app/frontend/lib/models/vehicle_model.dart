class Vehicle {
  ...
  Vehicle({
    ...
    this.puc,
  }) : registration = _formatReg(registration);
  ...
  static String _formatReg(String reg) {
    if (reg.isEmpty) return reg;

    // Remove any existing spaces or special characters
    final cleanReg = reg.replaceAll(RegExp(r'[^a-zA-Z0-9]'), '').toUpperCase();
